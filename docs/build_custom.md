...
> architecture that no longer exists. See `firmware/README.md` and
...
- Panel: 97.0" × 44.6" × 1.4" (8.08 × 3.72 ft), 62.0 lb
- Wattage: 620 W (0 yr old, monofacial)
- Bed: 96.0" × 45.6" (8.00 × 3.80 ft), 12" deep walls, bottomless
...
|---|---|---|---|
| 1x6 | 10 | 96.0" (8.00 ft) | long wall skin (N/S), 4 courses |
| 1x6 | 10 | 44.1" (3.68 ft) | short wall skin (W/E), 4 courses |
...
| 2x6 | 2 | 42.6" (3.55 ft) | cross frame rail |
| 2x4 | 1 | 106.3" (8.86 ft) | diagonal brace |
...
**Process:**
1. Lay out the 4 walls on a flat surface. Long walls are 96.0" (8.00 ft). Short walls are 42.6" (3.55 ft).
...
**Verification:** bed box is 96.0" × 45.6" outside, square (measure diagonally, both should be the same).
...
2. Place two 4x4×96.0" skids under the bed, aligned with the long walls.
...
**Process:**
1. Lay the 4 frame rails on a flat surface. Long rails are 96.0" (8.00 ft). Cross rails are 42.6" (3.55 ft).
2. The cross rails fit between the long rails. Butt joints (no miter).
3. Pre-drill 2 holes per corner. Drive #6 × 1.5" wood screws.

**Verification:** frame is 96.0" × 45.6" outside, square.
...
**Process:**
1. The 2x4×106.3" diagonal brace runs corner to corner inside the frame.
...
2. Position the 4 hinges evenly along the south rail. Spacing: 29.3" center-to-center, with 4" margin on each end.
...
**Process:**
1. Thread the ½" × 98.0" steel rod through all hinges, starting from one end.
...
**Tools:** hands (the panel weighs 62.0 lb).
...
**Total time:** ~8.7 hr (with pre-cut lumber and a clean workspace).
