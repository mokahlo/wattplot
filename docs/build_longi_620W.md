...
- Panel: 97.0" × 44.6" × 1.4" (8.08 × 3.72 ft), 65.0 lb
- Wattage: 620 W (0 yr old, bifacial)
- Bed: 96.0" × 44.6" (8.00 × 3.72 ft), 12" deep walls, bottomless
...
**Process:**
1. Lay out the 4 walls on a flat surface. Long walls are 96.0" (8.00 ft). Short walls are 41.6" (3.47 ft).
...
**Verification:** bed box is 96.0" × 44.6" outside, square (measure diagonally, both should be the same).
...
**Process:**
1. Lay the 4 frame rails on a flat surface. Long rails are 96.0" (8.00 ft). Cross rails are 41.6" (3.47 ft).
2. The cross rails fit between the long rails. Butt joints (no miter).
3. Pre-drill 2 holes per corner. Drive #6 × 1.5" wood screws.

**Verification:** frame is 96.0" × 44.6" outside, square.
...
**Process:**
1. The 2x4×105.9" diagonal brace runs corner to corner inside the frame.
...
**Tools:** hands (the panel weighs 65.0 lb).
