...
**Process:**
1. Lay out the 4 walls on a flat surface. Long walls are 65.0" (5.42 ft). Short walls are 36.0" (3.00 ft).
...
**Process:**
1. Lay the 4 frame rails on a flat surface. Long rails are 65.0" (5.42 ft). Cross rails are 36.0" (3.00 ft).
...
**Process:**
1. The 2x4×75.8" diagonal brace runs corner to corner inside the frame.
