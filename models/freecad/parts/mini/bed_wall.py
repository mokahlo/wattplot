"""
Mini v2.2 bed walls - 1x4 PT DF, half-lap corners.
18" x 14" outer, 1x4 walls (0.75 x 3.5 actual) on 1x2 skids.

Sized to fit the ECO-WORTHY 10W panel (13.3" x 8.1").
...
Design rules (enforced):
  1. NO MITER CUTS - every cut is 90 deg square. Half-lap notches at corners.
  2. ALL HARDWARE OFF THE SHELF - 1x4 PT DF, 1x2 PT DF.
  3. SIMPLE COMMON DIMENSIONS - 18" / 12.5" cuts from 1x4x8ft stock.
"""
import sys, os
...
def make_bed_short_wall(doc, side="west", name=None):
    ...
    short_L = BED_W - 2.0 * T   # 14 - 1.5 = 12.5"
...
if __name__ == "__main__":
    doc = App.newDocument("test_mini_bed_v22")
